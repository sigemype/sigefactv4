@php
    ...
    $document_note = ($document->note) ? $document->note : null;
    ...
    if($document_note)
    {
        $affected_document_number = $document_note->getAffectedDocumentNumberFull();
    }
        ...
        <td width="47%" class="border-box pl-3">
            <table class="full-width">
                ...
                <tr>
                    ...
                    <td class="font-sm">:</td>
                    <td class="font-sm">{{ $document_note->getNoteTypeDescription() }}</td>
                </tr>
                <tr>
                    <td class="font-sm font-bold" width="80px">Descripción</td>
                    <td class="font-sm">:</td>
                    <td class="font-sm">{{ $document_note->note_description }}</td>
                </tr>
                @endif
            </table>
        </td>

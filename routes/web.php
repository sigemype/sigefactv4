...
if ($hostname) {
	Route::domain($hostname->fqdn)->group(function () {
		...
		Route::middleware(['auth', 'redirect.module', 'locked.tenant'])->group(function () {
            ...
            Route::get('documents/edit/{id}', 'Tenant\DocumentController@edit')->middleware(['redirect.level', 'tenant.internal.mode']);
            Route::get('documents/show/{id}', 'Tenant\DocumentController@show');

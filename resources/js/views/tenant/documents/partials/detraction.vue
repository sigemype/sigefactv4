                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group" >
                            ...
                            <el-upload class="uploader" :headers="headers" :action="`/documents/pay-constancy/upload`" :show-file-list="false" :on-success="onSuccess">
...
<script>
    export default {
        ...
        async created(){
            await this.$http.get(`/${this.resource}/detraction/tables`).then(response => {
